# Example: Continuous Color Cycling
#
# Continuously increments border ($D020) and background ($D021) color registers
# in nested loops to cycle through all 16 colors. Outer loop runs 176
# iterations, inner loop 255, creating approximately 45,000 color changes. No
# raster synchronization is used, producing fast continuous color progression.
#
# Key Registers:
#   $D020 - VIC-II border color - incremented each iteration
#   $D021 - VIC-II background color - incremented each iteration
#   $E544 - KERNAL clear screen - setup
#
# Techniques: nested loop timing, continuous color increment, unsynchronized animation
# Hardware: VIC-II
#
