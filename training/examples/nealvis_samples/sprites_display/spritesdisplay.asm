# Example: Sprite Display and Configuration
#
# Displays two sprites (multicolor ship and single-color asteroid) with full
# configuration workflow. For each sprite: sets global multicolor palette
# ($D025/$D026), auto-detects sprite mode by testing byte 63 high nibble via
# BIT instruction, sets data pointer ($07F8/$07F9), individual color
# ($D027/$D028), enables via $D015 with ORA, and positions using $D000-$D003
# with MSB handling via $D010.
#
# Key Registers:
#   $D025/$D026 - VIC-II sprite multicolors - global palette
#   $D01C - VIC-II sprite multicolor mode - per-sprite mode bits
#   $07F8/$07F9 - Sprite data pointers
#   $D027/$D028 - VIC-II sprite 0/1 colors
#   $D015 - VIC-II sprite enable - bits set via ORA
#   $D010 - VIC-II sprite X MSB - 9th bit handling
#   $D000-$D003 - VIC-II sprite 0/1 X/Y positions
#
# Techniques: sprite mode auto-detection via BIT, multicolor setup, pointer calculation, position initialization
# Hardware: VIC-II
#
