# Example: KickAssembler Macro Demonstration
#
# Demonstrates KickAssembler macro definition and reuse with three macros:
# clear_screen_mac() calling KERNAL $E544, print_string_basic_mac() passing
# string address to BASIC $AB1E routine, and print_string_direct_mac()
# calculating screen offset and copying bytes. Main program calls each macro
# with different parameters to show flexibility.
#
# Key Registers:
#   $E544 - KERNAL clear screen
#   $AB1E - BASIC print string (A=low, Y=high)
#   $0400 - Screen RAM base for direct writes
#
# Techniques: macro definition, macro parameters, computed screen addresses, code reuse
# Hardware: VIC-II, KERNAL ROM
#
