...
#
# Minimal screen clear using single CHROUT call with control code $93 (CLR). KERNAL interprets
# this as a full screen clear instruction, providing the most efficient clear method with minimal
# code.
#
# Key Registers:
#   $FFD2 - KERNAL CHROUT - receives $93 control code for screen clear
#
# Techniques: KERNAL control codes, minimal code footprint
# Hardware: KERNAL ROM
#
