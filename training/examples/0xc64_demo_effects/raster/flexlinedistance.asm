# Example: FLD Bouncing Logo
#
# Advanced Flexible Line Distance effect manipulating $D011 bits 0-2 (vertical scroll) at precise
# scanlines to create variable line spacing. Bitmap mode is enabled at line 57 and FLD is applied
# before/after the bitmap section. A sine-table driven bounce controls the number of FLD lines,
# creating a bouncing logo effect.
#
# Key Registers:
#   $D012 - VIC-II raster line - multiple triggers at 15, 57, 121, 250
#   $D011 - VIC-II control 1 - bits 0-2 manipulated for FLD, bit 5 for bitmap mode
#   $D016 - VIC-II control 2 - multicolor mode setting
#   $D018 - VIC-II memory setup - switched between bitmap ($1D) and text ($15) modes
#
# Techniques: FLD effect, bitmap mode switching, sine-table animation, raster interrupt sequencing
# Hardware: VIC-II
#
