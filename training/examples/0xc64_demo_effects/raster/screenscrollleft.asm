...
#
# Scrolls the entire screen continuously to the left using $D016 hardware scroll bits. A delay
# counter controls animation speed. After each complete 8-pixel hardware scroll cycle, the
# character buffer is shifted left and a new character column is added on the right.
#
# Key Registers:
...
#
# Techniques: hardware scrolling, character buffer shifting, delay-based speed control
# Hardware: VIC-II
#
