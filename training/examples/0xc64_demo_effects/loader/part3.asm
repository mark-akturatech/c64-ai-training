# Example: Hardware Scroller with Raster Bars
#
# Implements horizontal text scroller using $D016 hardware scroll bits (0-2) at the bottom of the
# screen. Updates scroll position every 7 frames, shifts character buffer left, and loads new
# characters from message string. Overlays animated raster bars using sine table for height
# variation, creating a wave effect in the background.
#
# Key Registers:
#   $D012 - VIC-II raster line - multiple interrupts at 25, 242, 252
#   $D016 - VIC-II control 2 - bits 0-2 for hardware X scroll
#   $D021 - VIC-II background color - written per scanline for raster bars
#   $D018 - VIC-II memory setup - character set selection
#
# Techniques: hardware scrolling, character buffer shifting, raster bars, sine-table animation
# Hardware: VIC-II
#
