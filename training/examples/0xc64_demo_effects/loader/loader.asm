# Example: Multi-Part Demo Loader
#
# Framework for loading sequential demo parts from disk using KERNAL file I/O routines. Manages
# interrupts during loading and restores system state after each part completes. Dynamically
# updates filename pointers for sequential PART1/PART2/PART3 loading using SETLFS ($FFBA),
# SETNAME ($FFBD), and LOAD ($FFD5) KERNAL calls.
#
# Key Registers:
#   $0314/$0315 - IRQ vector - interrupt handler management
#   $DC0D/$DD0D - CIA interrupt control - managed during loading
#   $D019 - VIC-II interrupt status
#   KERNAL: $FFBA (SETLFS), $FFBD (SETNAME), $FFD5 (LOAD), $FFC3 (CLOSE)
#
# Techniques: disk I/O, interrupt management, code relocation, state restoration
# Hardware: KERNAL ROM, CIA
#
