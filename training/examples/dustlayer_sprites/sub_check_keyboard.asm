...
# input, then scans specific matrix rows for column patterns. Moves sprite
# Y-coordinate ($D001) with boundary checks at $1E minimum and $FF maximum.
#
# Key Registers:
...
#
# Techniques: keyboard matrix scanning, CIA port configuration, boundary checking
# Hardware: CIA, VIC-II
