...
#
# Configures VIC-II sprite 0 with multicolor mode, color palette, priority,
# and initial position. Sets sprite enable ($D015), multicolor mode ($D01C),
# priority ($D01B), multicolor palette colors ($D025/$D026), individual color
# ($D027), and positions sprite at X=$A0 Y=$FF with 9th X-bit enabled via
# $D010.
#
# Key Registers:
...
#
# Techniques: sprite mode configuration, multicolor setup, pointer calculation
# Hardware: VIC-II
