# Example: Sprite Demo Build Index
#
# Main build file for sprite tutorial defining CPU type, output filename,
# BASIC SYS loader at $0801, and code at $C000. Includes all sub-modules
# in assembly order.
#
# Key Registers:
