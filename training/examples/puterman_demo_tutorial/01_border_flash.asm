...
#
# Continuously cycles the VIC-II border color through all 16 colors by
# incrementing register $D020 in a tight infinite loop. No timing
# synchronization or interrupts are used. This is the simplest possible
# VIC-II hardware register demonstration.
#
# Key Registers:
#   $D020 - VIC-II border color - incremented each loop iteration
#
# Techniques: infinite loop, memory-mapped I/O
# Hardware: VIC-II
#
