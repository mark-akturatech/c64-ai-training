...
#
# Displays a Koala Paint format bitmap by copying screen RAM colors from
# $3F40 and color RAM data from $4328 into their respective VIC-II locations.
# Configures $D011 for bitmap mode (bit 5) with 25 rows, $D016 for multicolor
# mode (bit 4), and $D018 to point screen at $0400 and bitmap at $2000. The
# Koala format stores 8000 bytes bitmap, 1000 bytes screen color, 1000 bytes
# color RAM, and 1 byte background.
#
# Key Registers:
...
#
# Techniques: bitmap mode configuration, multicolor mode, Koala format parsing, bulk memory copy
# Hardware: VIC-II
#
