...
#
# Sets up the C64 interrupt system for raster-based timing. Disables CIA
# interrupts via $DC0D/$DD0D, configures custom IRQ vector at $0314/$0315,
# sets raster interrupt trigger at line 0 via $D012, and enables raster
# interrupts via $D01A. IRQ handler calls color wash and music subroutines
# synchronized to each frame.
#
# Key Registers:
...
#
# Techniques: raster interrupt setup, CIA interrupt disabling, custom IRQ handler
# Hardware: VIC-II, CIA
