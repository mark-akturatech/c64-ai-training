...
## Summary
Demonstrates frame-synchronized music playback by polling $D012 raster line register until the beam reaches line $80 (middle of screen), then calling a music play routine exactly once per frame. Border color $D020 is toggled to visualize CPU cycles consumed by the music player.
