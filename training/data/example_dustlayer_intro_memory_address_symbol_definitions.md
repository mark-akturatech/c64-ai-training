...
## Summary
Defines symbolic constants for SID music init routine ($1000), play routine ($1006), and data load address ($1000). Centralizes memory location references for clean code organization.
