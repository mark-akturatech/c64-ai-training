...
## Summary
Advanced Flexible Line Distance effect manipulating $D011 bits 0-2 (vertical scroll) at precise scanlines to create variable line spacing. Bitmap mode is enabled at line 57 and FLD is applied before/after the bitmap section. A sine-table driven bounce controls the number of FLD lines, creating a bouncing logo effect.
...
## Techniques
- FLD effect
- bitmap mode switching
- sine-table animation
- raster interrupt sequencing
