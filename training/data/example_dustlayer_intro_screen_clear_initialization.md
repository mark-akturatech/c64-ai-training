...
## Summary
Clears all 1024 bytes of screen RAM ($0400-$07E7) with space characters ($20) and sets Color RAM ($D800-$DBE7) to black ($00) across four memory pages. Border and background colors are set to black via VIC-II registers $D020 and $D021.
...
## Techniques
- loop-based screen fill
- page-aligned memory clear
