...
## Summary
Demonstrates KickAssembler macro definition and reuse with three macros: clear_screen_mac() calling KERNAL $E544, print_string_basic_mac() passing string address to BASIC $AB1E routine, and print_string_direct_mac() calculating screen offset and copying bytes. Main program calls each macro with different parameters to show flexibility.
