...
## Summary
Defines two snowflake sprite patterns (big and small) as 64-byte aligned blocks at $0B60 within the $0000-$3FFF VIC-II bank. Stores vertical Y-coordinate animation offsets for 8 sprites. Includes toSpritePtr() helper function that converts memory addresses to sprite pointer values by dividing by 64 within the current 16KB bank.
