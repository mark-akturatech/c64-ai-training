...
## Summary
Configures VIC-II to use custom character set at $3800 by setting bits 1-3 of $D018. Disables multicolor character mode by clearing bit 4 of $D016. Writes three text lines from data tables to screen RAM at $0428, $0478, and $0770.
