...
## Summary
Generates scrolling color bars using raster interrupts. Each interrupt sets $D021 background color from a lookup table with variable-width timing delays. Smooth animation through index cycling with AND #15 wrapping across a 16-entry color palette.
