...
## Summary
Defines symbolic constants for Screen RAM ($0400), SID init/play addresses ($11ED/$1004), animation delay counter ($90), and CIA port addresses ($DC00-$DC03) for keyboard scanning.
