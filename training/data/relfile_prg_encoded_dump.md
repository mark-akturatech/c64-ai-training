# RELFILE.PRG — uuencoded tok64 tokenized BASIC program

**Summary:** Encoded/tokenized dump of RELFILE.PRG (tok64 output) in uuencode-style beginning with "begin 644 RELFILE.PRG" and terminating with "end"; contains the tokenized C64 BASIC program data suitable for decoding back to a RELFILE.PRG binary/tok64 file.

## Description
This chunk is the machine-readable, ASCII-encoded copy of a tokenized BASIC program (RELFILE.PRG) produced by tok64. It is intended to be decoded (uue/uuencode-style) and written back as a binary/tok64 file for use on a Commodore-compatible system or emulator. The block starts with the standard "begin 644 RELFILE.PRG" header and ends with "end". After decoding you will get the tokenized PRG file (binary) exactly as produced by tok64.

(Decode with a standard uudecode utility — produces the RELFILE.PRG binary.)
...
## References
- "relative_file_basic_program" — human-readable BASIC source and explanation corresponding to this encoded dump