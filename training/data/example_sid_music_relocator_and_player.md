...
## Summary
Relocates SID music data from multiple 256-byte segments to $C000, then initializes the player at $C048. Raster interrupt at line 40 calls the music play routine each frame. Border color is toggled during playback to visualize CPU usage.
