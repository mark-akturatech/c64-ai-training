...
## Summary
Single-row scroller combining hardware X-scroll via $D016 with color animation. Updates both character and color RAM each frame for the bottom text row. A color gradient table provides 8-color fading effect on leading/trailing text edges, creating visual depth.
