...
## Summary
Simple wrapper subroutine that calls the SID music play routine at $1006. Called once per frame from the raster IRQ handler to maintain consistent playback timing.
