...
## Summary
Demonstrates five different methods for passing parameters to 6502 subroutines: registers only (A/X/Y), function-defined RAM block, self-modifying code, zero-page indirect addressing ($FB/$FC), and stack-based parameter passing. Each method prints a character at a calculated screen position, showing pros and cons regarding register usage, stack depth, and code complexity.
