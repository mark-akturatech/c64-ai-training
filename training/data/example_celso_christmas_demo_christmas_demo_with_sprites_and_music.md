...
## Summary
Complete demo using dual bitmap screens, falling snow sprite animation, scrolling text, and SID music playback. Dual-interrupt architecture: IRQ1 at scanline 240 handles text mode and music; IRQ2 at scanline 10 switches to bitmap mode with alternating pictures. VIC-II bank switching via CIA2 ($DD00) addresses different 16KB regions. Random number generation combines $D012 raster counter with CIA timer values ($DC04/$DC05). Horizontal pixel scrolling uses $D016 bits 0-2.
...
- bitmap/text mode switching
- random number generation
- SID music integration

## Hardware
VIC-II, SID, CIA1, CIA2
