...
## Summary
Framework for loading sequential demo parts from disk using KERNAL file I/O routines. Manages interrupts during loading and restores system state after each part completes. Dynamically updates filename pointers for sequential PART1/PART2/PART3 loading using SETLFS ($FFBA), SETNAME ($FFBD), and LOAD ($FFD5) KERNAL calls.
