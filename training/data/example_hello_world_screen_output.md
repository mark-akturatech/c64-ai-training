...
## Summary
Demonstrates two methods of printing text: BASIC ROM routine at $AB1E for formatted output, and direct screen RAM writes. Clears screen via KERNAL routine at $E544, prints "HELLO VIA BASIC" using BASIC's print string routine (address in A/Y registers), then writes "hello direct" by copying bytes directly to screen RAM at $0500.
