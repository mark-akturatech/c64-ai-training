# ca65 predefined target-system constants

**Summary:** List of ca65 assembler predefined target-system symbols for conditional assembly and portability (e.g. __C64__, __PLUS4__, __ATARI__). These symbols are defined automatically by ca65 depending on the selected target system and can be used with conditional assembly directives (IFDEF/IFNDEF).

## Predefined constants
The assembler defines the following symbols depending on the target system selected:
...
## References
- "ca65 Users Guide" — list of predefined target-system constants (section 14)