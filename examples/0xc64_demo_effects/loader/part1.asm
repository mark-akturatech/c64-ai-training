# Example: Animated Raster Bars with Border
#
# Generates raster interrupt-driven color bars at top and bottom of screen. Renders bars by
# switching $D020 border color at precise scanlines using chained interrupts at lines 49, 250,
# and 255. Updates bar colors from lookup table with delay-based smoothing. Detects keyboard
# input via CIA ports for part exit.
#
# Key Registers:
#   $D012 - VIC-II raster line - interrupt triggers at 49, 250, 255
#   $D019 - VIC-II interrupt status - acknowledged in handler
#   $D020 - VIC-II border color - set per scanline for bar effect
#   $DC00/$DC01 - CIA keyboard ports - scanned for space key
#
# Techniques: raster interrupt chaining, timing-critical color changes, keyboard input
# Hardware: VIC-II, CIA
#
