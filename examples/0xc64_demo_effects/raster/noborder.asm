...
#
# Removes top/bottom screen borders by toggling $D011 bit 3 (25-row/24-row mode) at precise
# scanlines. Sets 24-row mode at line 249 to trick VIC-II into not drawing the border, then
# restores 25-row mode at line 252. This creates the illusion of an extended screen area.
#
# Key Registers:
...
#
# Techniques: border removal, timing-critical register switching, raster interrupts
# Hardware: VIC-II, CIA
#
