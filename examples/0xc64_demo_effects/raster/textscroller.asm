# Example: Colored Text Scroller
#
# Single-row scroller combining hardware X-scroll via $D016 with color animation. Updates both
# character and color RAM each frame for the bottom text row. A color gradient table provides
# 8-color fading effect on leading/trailing text edges, creating visual depth.
#
# Key Registers:
#   $D016 - VIC-II control 2 - hardware scroll bits
#   $D020/$D021 - VIC-II border/background - set to black
#   $D012 - VIC-II raster line - triggers at 0 and 242
#   $07C0-$07E7 - Screen RAM bottom row
#   $DBC0-$DBE7 - Color RAM bottom row - gradient colors applied
#
# Techniques: hardware scrolling, color animation, character cycling, gradient effects
# Hardware: VIC-II
#
