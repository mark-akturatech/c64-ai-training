# Example: SID Music Relocator and Player
#
# Relocates SID music data from multiple 256-byte segments to $C000, then initializes the player
# at $C048. Raster interrupt at line 40 calls the music play routine each frame. Border color is
# toggled during playback to visualize CPU usage.
#
# Key Registers:
#   $D012 - VIC-II raster line - interrupt trigger at line 40
#   $D019 - VIC-II interrupt status - acknowledged
#   $D020 - VIC-II border color - toggled for CPU visualization
#   $D01A - VIC-II interrupt mask - raster interrupt enabled
#   $DC0D/$DD0D - CIA interrupt control - disabled
#   $0314/$0315 - IRQ vector - custom handler address
#
# Techniques: code relocation, raster interrupts, CPU load visualization
# Hardware: VIC-II, SID, CIA
#
