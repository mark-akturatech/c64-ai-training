...
#
# Copies 40 characters from two data tables into screen RAM at specific
# positions ($0590 and $05E0). Uses indexed addressing with X register to
# loop through all 40 columns per line.
#
# Key Registers:
#   $0590/$05E0 - VIC-II Screen RAM - text placement locations
#
# Techniques: indexed memory copy, table-driven text output
# Hardware: VIC-II
