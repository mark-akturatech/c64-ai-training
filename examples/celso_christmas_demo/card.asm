# Example: Christmas Demo with Sprites and Music
#
# Complete demo using dual bitmap screens, falling snow sprite animation,
# scrolling text, and SID music playback. Dual-interrupt architecture: IRQ1 at
# scanline 240 handles text mode and music; IRQ2 at scanline 10 switches to
# bitmap mode with alternating pictures. VIC-II bank switching via CIA2 ($DD00)
# addresses different 16KB regions. Random number generation combines $D012
# raster counter with CIA timer values ($DC04/$DC05). Horizontal pixel scrolling
# uses $D016 bits 0-2.
#
# Key Registers:
#   $D012 - VIC-II raster line - dual interrupt triggers at 10 and 240
#   $D016 - VIC-II control 2 - horizontal scroll bits 0-2
#   $D018 - VIC-II memory control - screen/bitmap mapping per mode
#   $D015 - VIC-II sprite enable - all 8 sprites for snow particles
#   $D000-$D00E - VIC-II sprite positions - animated per frame
#   $DD00 - CIA2 data port A - VIC-II bank selection
#   $DC04/$DC05 - CIA1 timer A - random number generation source
#   $D019 - VIC-II interrupt status - acknowledged per handler
#   $0314/$0315 - IRQ vector - switched between two handlers
#
# Techniques: dual-interrupt architecture, VIC-II bank switching, sprite animation, horizontal scrolling, bitmap/text mode switching, random number generation, SID music integration
# Hardware: VIC-II, SID, CIA1, CIA2
