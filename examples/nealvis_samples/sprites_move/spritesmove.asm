# Example: Sprite Movement with Stack Parameters
#
# Animates two sprites: ship moves left-to-right with wrapping at screen edge,
# asteroid moves top-to-bottom with reset at bottom. Uses stack-based parameter
# passing where movement amount is pushed before JSR, then popped inside the
# subroutine after saving the return address. Implements 16-bit X position
# arithmetic with carry flag for MSB overflow handling. Synchronized to
# scanlines via wait macro.
#
# Key Registers:
#   $D000-$D003 - VIC-II sprite 0/1 positions - updated per frame
#   $D010 - VIC-II sprite X MSB - carry flag handling
#   Stack - parameter passing for movement amounts
#
# Techniques: stack parameter passing, 16-bit arithmetic, carry flag handling, scanline synchronization, boundary wrapping
# Hardware: VIC-II
#
