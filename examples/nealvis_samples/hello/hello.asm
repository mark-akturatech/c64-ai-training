# Example: Hello World Screen Output
#
# Demonstrates two methods of printing text: BASIC ROM routine at $AB1E for
# formatted output, and direct screen RAM writes. Clears screen via KERNAL
# routine at $E544, prints "HELLO VIA BASIC" using BASIC's print string routine
# (address in A/Y registers), then writes "hello direct" by copying bytes
# directly to screen RAM at $0500.
#
# Key Registers:
#   $E544 - KERNAL clear screen routine
#   $AB1E - BASIC print string routine (A=low, Y=high address)
#   $0400 - Screen RAM base
#
# Techniques: KERNAL routine calls, BASIC ROM integration, direct screen RAM writes
