# Example: Parameter Passing Techniques
#
# Demonstrates five different methods for passing parameters to 6502
# subroutines: registers only (A/X/Y), function-defined RAM block,
# self-modifying code, zero-page indirect addressing ($FB/$FC), and
# stack-based parameter passing. Each method prints a character at a
# calculated screen position, showing pros and cons regarding register
# usage, stack depth, and code complexity.
#
# Key Registers:
#   $FB/$FC - Zero-page pointer - indirect addressing for parameter blocks
#   $0400 - Screen RAM base
#   Stack ($01FF-$0100) - parameter storage for stack method
#
# Techniques: register passing, RAM parameter blocks, self-modifying code, zero-page indirect, stack parameter passing
# Hardware: CPU (6502 techniques)
#
