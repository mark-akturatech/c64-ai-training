# Example: Sprite Demo Main Loop with Border Opening
#
# Sets up raster interrupt system and implements border opening technique.
# IRQ handler calls color cycling, sprite animation, keyboard checking, and
# music routines. Opens top/bottom borders by toggling $D011 bit 3 at raster
# lines 249 and 255, switching between 24 and 25 row modes.
#
# Key Registers:
#   $DC0D/$DD0D - CIA interrupt control - disabled
#   $D01A - VIC-II interrupt mask - raster IRQ enabled
#   $D012 - VIC-II raster line - trigger at 0
#   $D011 - VIC-II control 1 - bit 3 toggled for border opening
#   $D020 - VIC-II border color
#   $0314/$0315 - IRQ vector
#   $D019 - VIC-II interrupt status
#
# Techniques: raster interrupts, border opening, multiple ISR subroutines
# Hardware: VIC-II, CIA
