...
#
# Cycles text colors using sprite pointer value (0-15) as color source with
# ADC/SBC to constrain range. Writes animated colors to three Color RAM row
# addresses ($D828, $D878, $DB70). Separately implements slower border color
# flipping using a delay counter and EOR #$08 toggle between blue and light
# blue on $D020.
#
# Key Registers:
...
#
# Techniques: register-driven color cycling, delay-based timing, XOR toggling
# Hardware: VIC-II
